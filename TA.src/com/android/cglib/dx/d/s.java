...
public final class s
{
  ...
  public s(Writer paramWriter, int paramInt1, int paramInt2, String paramString)
  {
    ...
    this.a = paramWriter;
    this.b = paramInt1;
    this.c = localStringWriter1.getBuffer();
    this.d = localStringWriter2.getBuffer();
    this.e = new j(localStringWriter1, paramInt1);
    this.f = new j(localStringWriter2, paramInt2, paramString);
  }

  public static String a(String paramString1, int paramInt1, String paramString2, String paramString3, int paramInt2)
  {
    StringWriter localStringWriter = new StringWriter(3 * (paramString1.length() + paramString3.length()));
    s locals = new s(localStringWriter, paramInt1, paramInt2, paramString2);
    try
    {
      locals.a().write(paramString1);
      locals.b().write(paramString3);
      locals.c();
  ...
  private void d()
  {
    while (true)
    {
      ...
      {
        a(this.a, this.b - i);
        this.a.write(this.d.substring(0, j));
      }
      this.a.write(10);
      this.c.delete(0, i + 1);
      this.d.delete(0, j + 1);
 ...
 * Qualified Name:     com.android.cglib.dx.d.s
